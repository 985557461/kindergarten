 ...
 */
public class ActivityWeightSelect extends ActivityBaseNoSliding implements View.OnClickListener {

    public static void open(Activity activity) {
        Intent intent = new Intent(activity, ActivityWeightSelect.class);
